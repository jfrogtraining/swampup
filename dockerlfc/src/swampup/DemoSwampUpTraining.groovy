...
class DemoSwampUpTraining extends GroovyTestCase {
    def artifactoryUrl = 'http://35.197.6.224/artifactory'
    ...
    void test1_testLatestDockerApp () {
        testLatestApp = "/Users/stanleyf/git/swampup/dockerlfc/src/swampup/latestDockerApp.aql"
        testApp.setAqlFile(testLatestApp)
        testApp.runTest()
    }

    void test2_giveApprovalForRelease () {
        testLatestApp = "/Users/stanleyf/git/swampup/dockerlfc/src/swampup/qaApprovalCriteria.aql"
        testApp.setAqlFile(testLatestApp)
        testApp.sendApproval()
    }

    void test3_devOpsDeployRelease () {
        testLatestApp = "/Users/stanleyf/git/swampup/dockerlfc/src/swampup/latestDockerAppReleaseApproval.aql"
        testApp.setAqlFile(testLatestApp)
        testApp.downloadToProduction()
    }

    void test4_whereDeployed () {
        testLatestApp = "/Users/stanleyf/git/swampup/dockerlfc/src/swampup/listPropertiesOnDeployedDockerApp.aql"
        testApp.setAqlFile(testLatestApp)
